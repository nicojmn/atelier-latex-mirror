...
\begin{frame}
  ...
  Chercher de l'information:
    \begin{itemize}
        \item \url{http://en.wikibooks.org/wiki/LaTeX} % still working 11/02/24
        \item \url{https://www.overleaf.com/learn/latex/Learn_LaTeX_in_30_minutes} % still working 11/02/24
            \item \url{http://www.andy-roberts.net/writing/latex} % still working 11/02/24
            \item \url{http://ctan.org/pkg/packagename} ou \lstinline[language=sh,morekeywords={texdoc}]{$ texdoc packagename} % yeah
        \item Google est ton ami ! % obviously still working
            \item \url{https://www.overleaf.com/learn}
            \item La version de StackExchange spécialisée pour le \TeX:
  \url{https://tex.stackexchange.com}. % still working 11/02/24
        \item Livres:
        \begin{itemize}
...
\begin{frame}[fragile]
  \begin{columns}
    \begin{column}{0.45\textwidth}
      % TODO : Insert the tikz code here
    \end{column}
    \begin{column}{0.45\textwidth}
      \begin{figure}[!ht] \centering
        \includegraphics[width=0.8\textwidth]{img/turbine} % TODO : replace your new image here
      \end{figure}
    \end{column}
  \end{columns}
