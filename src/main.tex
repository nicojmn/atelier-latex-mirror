...
\begin{frame}{Quels logiciels pour utiliser \LaTeX{}?}
  ...
  \begin{itemize}
	  ...
	  \end{itemize}
  \end{itemize}
  Pour cet atelier, nous vous conseillons d'utiliser \textbf{overleaf} sur votre propre PC ou sur les PC de l'UCL. 
\end{frame}
...
À nouveau la première ligne est indentée. 
      ...
      \end{column}
      \begin{column}{0.5\textwidth}
        \fbox{\includegraphics[width=1\textwidth,trim={1.5cm 14cm 1.5cm 1cm},clip]{examples/structure/build_latex/main.pdf}}
      \end{column}
	\end{columns}
    \begin{itemize}
...
\end{document}
      ...
      \begin{column}{0.5\textwidth}
	\centering
        \fbox{\includegraphics[width=1\textwidth,trim={1.5cm 10cm 1.5cm 1cm},clip]{examples/title/build_latex/main.pdf}}
      \end{column}
	\end{columns}
\end{frame}
...
\begin{center}
\fbox{\includegraphics[height=7cm,trim={1.5cm 8cm 1.5cm 3cm},clip]{exercices/1/build_latex/main.pdf}}
\end{center}
...
\end{column}
\begin{column}{0.5\textwidth}
Sur la figure~\ref{fig:ucl}, vous pouvez voir le logo UCLouvain
...
\begin{frame}[fragile]
  ...
  \begin{itemize}
	...
	\end{itemize}
    \item On utilise le fichier \texttt{biblio.bib} dans le document via la commande \lstinline|\bibliography{biblio.bib}|.
...
\begin{frame}[fragile]
	...
	\begin{center}
		...
		\fbox{\includegraphics[width=0.8\textwidth,trim={2cm 18cm 2cm 2cm},clip]{exercices/bib/build_latex/main.pdf}}
	\end{center}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{center}
		\fbox{\includegraphics[width=0.8\textwidth,trim={2cm 16cm 2cm 2cm},clip]{exercices/3/build_latex/main.pdf}}
	\end{center}
\end{frame}
