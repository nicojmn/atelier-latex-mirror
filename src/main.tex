...
\author{Louis \textsc{Arys}
        \and Sébastien \textsc{de Longueville}}

                    % today
\date{5 october 2017} % fixed date
\date{}             % no date
        \end{lstlisting}
...
\begin{frame}[fragile]{Premier exercice}
    ...
    \begin{column}{0.5\textwidth}
      \begin{center}\large
        Exercice sur Overleaf:
        
        \vspace{0.25cm}
        \fbox{\url{http://bit.ly/2lXEyPH}}
      \end{center}
    \end{column}
    \begin{column}{0.5\textwidth}
      \begin{center}\large
        ...
        \vspace{0.25cm}
        \fbox{\url{http://bit.ly/2wzoGVm}}
      \end{center}
        \vfill
    \end{column}
	\end{columns}
  Cliquez sur \og{}Clone this project\fg{} pour commencer à écrire.
  \vspace{0.25cm}
...
\begin{frame}[fragile]{Deuxième exercice}
  ...
  \begin{itemize}
    ...
    \item mettre un des mots en très grand, et un autre en très petit;
    \item faire une liste numérotée avec un type de police différent pour chaque élément;
    \item faire une liste à puce avec un style de police différent pour chaque élément;
...
\begin{frame}[fragile]{Troisième exercice}
  ...
  \begin{itemize}
	  ...
	  \end{itemize}
  \end{itemize}
  {\footnotesize Une image vous est fournie dans 
  \lstinline|Leslie_Lamport.jpg|}.
\end{frame}
...
\end{columns}
\framebreak
	\item Utilisation de l'environnement \lstinline|systeme| 
      (du package \lstinline|systeme|)
      pour faire un système d'équations.
	\begin{columns}
		\begin{column}{0.5\textwidth}
          \[ \systeme{x^2+y = 3, \frac{y}{x} = 0.42} \]
		\end{column}
		\begin{column}{0.5\textwidth}
			\begin{lstlisting}[style=nonumbers]
\[
...
\begin{frame}[fragile]{Cinquième exercice} 
  \begin{center}\large 
    Exemple de résultat: 
