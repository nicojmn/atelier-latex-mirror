...
Introduction à l'écriture de documents \LaTeX}
...
\begin{frame}[fragile]{Premier exercice}
    ...
    \end{column}
	\end{columns}
  {\footnotesize{Cliquez sur \og{}Clone this project\fg{} pour commencer à écrire.}}
  \vspace{0.25cm}
...
\end{matrix}$$
				...
				\end{column}
			\end{columns}
		\item On ajoute des délimiteurs avec \lstinline|pmatrix|,\lstinline|vmatrix|,...
			\begin{columns}
				\begin{column}{0.45\textwidth}
					$$\begin{pmatrix}
						a + b & c \\
