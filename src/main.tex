...
\begin{center}
\fbox{\includegraphics[height=7cm,trim={2cm 8cm 2cm 4cm},clip]{exercices/3/build_latex/main.pdf}}
\end{center}
\end{frame}
...
\begin{frame}[fragile]
	...
	\begin{center}
		\fbox{\includegraphics[width=0.8\textwidth,trim={2cm 16cm 2cm 2cm},clip]{exercices/4/build_latex/main.pdf}}
	\end{center}
\end{frame}
