...
\lstinline|\usepackage{lmodern}| & Pour les polices 
\end{tabular}
...
\begin{frame}[fragile]{Premier exercice}
  \begin{center}\large
    Cliquez sur ce lien, puis sur \og{}Clone this project\fg{}, pour commencer le premier exercice:
  ...
  \begin{itemize}
	  ...
	  \item écrir un peu de \textbf{texte};
