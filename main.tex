...
\begin{frame}[fragile]{L'environnement mathématique}
\framesubtitle{Math Operators}
Les opérateurs mathématiques sont $\lim, \min, \max, \sum, \prod, \ldots$.
Quelle différence ? Leurs indices et exposant sont au dessus et en dessous mais pas à leur droite.
...
\begin{frame}[fragile]{L'environnement mathématique}
\framesubtitle{Définition de Math Operator ou Command}
Les opérateurs mathématiques sont $\lim, \min, \max, \sum, \prod, \ldots$.
Quelle différence ? Leurs indices et exposant sont au dessus et en dessous mais pas à leur droite.
...
\DeclareMathOperator{\pot}{potato}
\let\min\relax
